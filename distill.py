...
from utils.utils_fit import fit_one_epoch, fit_one_epoch_distill, fit_one_epoch_feat_distill
...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------------#
    classes_path = 'model_data/VisDrone_yolo_classes.txt'
    # ---------------------------------------------------------------------#
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = r'H:\ozhiquan\yolov5-pytorch\logs_VisDrone-l_tiny\ep010-loss1.143-val_loss0.169.pth'#r'H:\ozhiquan\yolov5-pytorch\logs_VisDrone\logs-l_tiny\best_epoch_weights.pth' # r'H:\ozhiquan\yolov5-pytorch\logs_VisDrone\logs-x-l_tiny\best_epoch_weights.pth'
    t_model_path = r'H:\ozhiquan\yolov5-pytorch\map_out_visdrone\map_out_v7x_l_31.2_visdrone-test\best_epoch_weights.pth'
    # ------------------------------------------------------#
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            if distill:
                fit_one_epoch_feat_distill(model_train, t_model_train, model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch,
                              epoch_step,
